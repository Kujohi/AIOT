...
def index():
    if request.method == 'POST':
        ...
        pro = probabilities[0][plant_one_hot][0]
        formatted_probability = f"{(pro * 100):.2f}/{100}"
        print(formatted_probability)
        return render_template('index.html', probs=formatted_probability, plant_types=plant_types)
